This project includes some data cleaning steps on a housing dataset.
...
-- As can be seen, Split_part() is much easier to use in terms of syntax, than the combination of substring() and position().
...
HAVING COUNT(*) > 1;
-- Now you see all those duplicates (according to my consideration).
